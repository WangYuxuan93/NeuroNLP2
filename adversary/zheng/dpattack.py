...
from adversary.zheng.dp_attacker import DPAttacker
...
def attack(attacker, alg, data, network, pred_writer, adv_gold_writer, punct_set, word_alphabet, pos_alphabet, 
    ...
    for data in iterate(data, batch_size):
        ...
        for i in range(len(lengths)):
            ...
            succ_flag, num_edit, total_change_score, total_perp_diff, total_head_change, total_rel_change = adv_infos
...
def parse(args):
    ...
    attacker = DPAttacker(network, candidates, vocab, synonyms, filters=filters, generators=generators,
...
if __name__ == '__main__':
    ...
    args_parser.add_argument('--mode', choices=['black'], required=True, help='processing mode')
