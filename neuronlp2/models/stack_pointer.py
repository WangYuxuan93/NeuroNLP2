...
class StackPtrParser(RobustParser):
    def __init__(self, hyps, num_pretrained, num_words, num_chars, num_pos, num_labels,
        ...
        super(StackPtrParser, self).__init__(hyps, num_pretrained, num_words, num_chars, num_pos,
        ...
        dec_dim = encoder_hidden_size // 2
        self.src_dense = nn.Linear(self.enc_out_dim, dec_dim)
        ...
        self.hx_dense = nn.Linear(2 * decoder_hidden_size, decoder_hidden_size)

    def init_biaffine(self):
        hid_size = self.dec_out_dim
        self.arc_h = nn.Linear(self.dec_out_dim, self.arc_mlp_dim)
        self.arc_c = nn.Linear(self.enc_out_dim, self.arc_mlp_dim)
    ...
    def forward(self, input_word, input_pretrained, input_char, input_pos, heads, stacked_heads, 
                ...
                bpes=None, first_idx=None, lan_id=None):
