#!/usr/bin/env bash
CUDA_VISIBLE_DEVICES="" OMP_NUM_THREADS=4 python -u easyfirst_parsing.py --mode train --config configs/parsing/easyfirst.json --num_epochs 400 \
 --batch_size 32 --step_batch_size 16 \
